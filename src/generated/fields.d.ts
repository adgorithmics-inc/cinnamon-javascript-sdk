...
export declare type NotificationField = 'id' | 'creationDate' | 'lastChangeDate' | 'title' | 'message' | 'status' | 'severity' | 'code' | 'resource{id}' | 'resource{creationDate}' | 'resource{lastChangeDate}' | 'resource{systemStatus}' | 'resource{errors}' | 'resource{warnings}';
