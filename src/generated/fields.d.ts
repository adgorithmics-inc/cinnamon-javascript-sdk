...
export declare type OrganizationField = 'id' | 'creationDate' | 'lastChangeDate' | 'name' | 'systemStatus' | 'errors' | 'tier' | 'users{edges{node{id}}}' | 'users{edges{node{creationDate}}}' | 'users{edges{node{lastChangeDate}}}' | 'users{edges{node{email}}}' | 'users{edges{node{firstName}}}' | 'users{edges{node{lastName}}}' | 'users{edges{node{organizations{totalCount}}}}' | 'users{edges{node{entitlements{totalCount}}}}' | 'users{edges{cursor}}' | 'users{pageInfo{endCursor}}' | 'users{pageInfo{startCursor}}' | 'users{pageInfo{hasNextPage}}' | 'users{pageInfo{hasPreviousPage}}' | 'users{totalCount}' | 'marketplaces{edges{node{id}}}' | 'marketplaces{edges{node{creationDate}}}' | 'marketplaces{edges{node{lastChangeDate}}}' | 'marketplaces{edges{node{name}}}' | 'marketplaces{edges{node{systemStatus}}}' | 'marketplaces{edges{node{errors}}}' | 'marketplaces{edges{node{organization{id}}}}' | 'marketplaces{edges{node{organization{creationDate}}}}' | 'marketplaces{edges{node{organization{lastChangeDate}}}}' | 'marketplaces{edges{node{organization{name}}}}' | 'marketplaces{edges{node{organization{systemStatus}}}}' | 'marketplaces{edges{node{organization{errors}}}}' | 'marketplaces{edges{node{organization{tier}}}}' | 'marketplaces{edges{node{mediaChannels{totalCount}}}}' | 'marketplaces{edges{node{campaignTemplates{totalCount}}}}' | 'marketplaces{edges{node{vendors{totalCount}}}}' | 'marketplaces{edges{node{vendorTokens{totalCount}}}}' | 'marketplaces{edges{node{creativeTemplates{totalCount}}}}' | 'marketplaces{edges{node{products{totalCount}}}}' | 'marketplaces{edges{cursor}}' | 'marketplaces{pageInfo{endCursor}}' | 'marketplaces{pageInfo{startCursor}}' | 'marketplaces{pageInfo{hasNextPage}}' | 'marketplaces{pageInfo{hasPreviousPage}}' | 'marketplaces{totalCount}';
...
export declare type UserField = 'id' | 'creationDate' | 'lastChangeDate' | 'email' | 'firstName' | 'lastName' | 'organizations{edges{node{id}}}' | 'organizations{edges{node{creationDate}}}' | 'organizations{edges{node{lastChangeDate}}}' | 'organizations{edges{node{name}}}' | 'organizations{edges{node{systemStatus}}}' | 'organizations{edges{node{errors}}}' | 'organizations{edges{node{tier}}}' | 'organizations{edges{node{users{totalCount}}}}' | 'organizations{edges{node{marketplaces{totalCount}}}}' | 'organizations{edges{cursor}}' | 'organizations{pageInfo{endCursor}}' | 'organizations{pageInfo{startCursor}}' | 'organizations{pageInfo{hasNextPage}}' | 'organizations{pageInfo{hasPreviousPage}}' | 'organizations{totalCount}' | 'entitlements{edges{node{id}}}' | 'entitlements{edges{node{creationDate}}}' | 'entitlements{edges{node{lastChangeDate}}}' | 'entitlements{edges{node{type}}}' | 'entitlements{edges{node{permissions}}}' | 'entitlements{edges{node{user{id}}}}' | 'entitlements{edges{node{user{creationDate}}}}' | 'entitlements{edges{node{user{lastChangeDate}}}}' | 'entitlements{edges{node{user{email}}}}' | 'entitlements{edges{node{user{firstName}}}}' | 'entitlements{edges{node{user{lastName}}}}' | 'entitlements{edges{node{resource{id}}}}' | 'entitlements{edges{node{resource{creationDate}}}}' | 'entitlements{edges{node{resource{lastChangeDate}}}}' | 'entitlements{edges{node{resource{name}}}}' | 'entitlements{edges{node{resource{systemStatus}}}}' | 'entitlements{edges{node{resource{errors}}}}' | 'entitlements{edges{cursor}}' | 'entitlements{pageInfo{endCursor}}' | 'entitlements{pageInfo{startCursor}}' | 'entitlements{pageInfo{hasNextPage}}' | 'entitlements{pageInfo{hasPreviousPage}}' | 'entitlements{totalCount}';
...
export declare type TokenField = 'token' | 'refreshToken' | 'expiryDate' | 'user{id}' | 'user{creationDate}' | 'user{lastChangeDate}' | 'user{email}' | 'user{firstName}' | 'user{lastName}' | 'user{organizations{edges{node{id}}}}' | 'user{organizations{edges{node{creationDate}}}}' | 'user{organizations{edges{node{lastChangeDate}}}}' | 'user{organizations{edges{node{name}}}}' | 'user{organizations{edges{node{systemStatus}}}}' | 'user{organizations{edges{node{errors}}}}' | 'user{organizations{edges{node{tier}}}}' | 'user{organizations{edges{cursor}}}' | 'user{organizations{pageInfo{endCursor}}}' | 'user{organizations{pageInfo{startCursor}}}' | 'user{organizations{pageInfo{hasNextPage}}}' | 'user{organizations{pageInfo{hasPreviousPage}}}' | 'user{organizations{totalCount}}' | 'user{entitlements{edges{node{id}}}}' | 'user{entitlements{edges{node{creationDate}}}}' | 'user{entitlements{edges{node{lastChangeDate}}}}' | 'user{entitlements{edges{node{type}}}}' | 'user{entitlements{edges{node{permissions}}}}' | 'user{entitlements{edges{cursor}}}' | 'user{entitlements{pageInfo{endCursor}}}' | 'user{entitlements{pageInfo{startCursor}}}' | 'user{entitlements{pageInfo{hasNextPage}}}' | 'user{entitlements{pageInfo{hasPreviousPage}}}' | 'user{entitlements{totalCount}}';
