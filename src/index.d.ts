...
export declare class Cinnamon {
    ...
    organizations(filter?: OrganizationsFilterInput, fields?: Array<keyof OrganizationFields>, headers?: Headers, token?: string): Promise<Partial<import("./generated/graphql").Organization>[]>;
    ...
    marketplaces(filter?: MarketplacesFilterInput, fields?: Array<keyof MarketplaceFields>, headers?: Headers, token?: string): Promise<Partial<import("./generated/graphql").Marketplace>[]>;
    ...
    mediaChannels(filter?: MediaChannelsFilterInput, fields?: Array<keyof MediaChannelFields>, headers?: Headers, token?: string): Promise<Partial<import("./generated/graphql").MediaChannel>[]>;
    ...
    campaignTemplates(filter?: CampaignTemplatesFilterInput, fields?: Array<keyof CampaignTemplateFields>, headers?: Headers, token?: string): Promise<Partial<CampaignTemplate>[]>;
    ...
    vendors(filter?: VendorsFilterInput, fields?: Array<keyof VendorFields>, headers?: Headers, token?: string): Promise<Partial<import("./generated/graphql").Vendor[]>>;
    ...
    catalogs(filter?: CatalogsFilterInput, fields?: Array<keyof CatalogFields>, headers?: Headers, token?: string): Promise<Partial<import("./generated/graphql").Catalog>[]>;
    ...
    products(filter?: ProductsFilterInput, fields?: Array<keyof ProductFields>, headers?: Headers, token?: string): Promise<Partial<import("./generated/graphql").Product>[]>;
    ...
    marketingCampaigns(filter?: MarketingCampaignsFilterInput, fields?: Array<keyof MarketingCampaignFields>, headers?: Headers, token?: string): Promise<Partial<import("./generated/graphql").MarketingCampaign>[]>;
    ...
    marketingAds(filter?: MarketingAdsFilterInput, fields?: Array<keyof MarketingAdFields>, headers?: Headers, token?: string): Promise<Partial<import("./generated/graphql").MarketingAd>[]>;
    ...
    results(filter?: ResultsFilterInput, fields?: Array<keyof ResultFields>, headers?: Headers, token?: string): Promise<Partial<import("./generated/graphql").Result>[]>;
    ...
    entitlements(filter?: EntitlementsFilterInput, fields?: Array<keyof EntitlementFields>, headers?: Headers, token?: string): Promise<Partial<import("./generated/graphql").Entitlement>[]>;
