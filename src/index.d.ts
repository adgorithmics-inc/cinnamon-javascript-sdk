...
export declare class Cinnamon {
    ...
    organizations(filter?: Scalars['FilterInput'], sort?: SortInput, after?: PageInfo['endCursor'], fields?: Array<keyof OrganizationFields | string>, headers?: Headers, token?: string): Promise<import("./generated/graphql").OrganizationConnection>;
    organizationsAll(filter?: Scalars['FilterInput'], sort?: SortInput, fields?: Array<keyof OrganizationFields | string>, headers?: Headers, token?: string): Promise<Organization[]>;
    ...
    marketplaces(filter?: Scalars['FilterInput'], sort?: SortInput, after?: PageInfo['endCursor'], fields?: Array<keyof MarketplaceFields | string>, headers?: Headers, token?: string): Promise<import("./generated/graphql").MarketplaceConnection>;
    marketplacesAll(filter?: Scalars['FilterInput'], sort?: SortInput, fields?: Array<keyof MarketplaceFields | string>, headers?: Headers, token?: string): Promise<Marketplace[]>;
    ...
    mediaChannels(filter?: Scalars['FilterInput'], sort?: SortInput, after?: PageInfo['endCursor'], fields?: Array<keyof MediaChannelFields | string>, headers?: Headers, token?: string): Promise<import("./generated/graphql").MediaChannelConnection>;
    mediaChannelsAll(filter?: Scalars['FilterInput'], sort?: SortInput, fields?: Array<keyof MediaChannelFields | string>, headers?: Headers, token?: string): Promise<MediaChannel[]>;
    ...
    campaignTemplates(filter?: Scalars['FilterInput'], sort?: SortInput, after?: PageInfo['endCursor'], fields?: Array<keyof CampaignTemplateFields | string>, headers?: Headers, token?: string): Promise<import("./generated/graphql").CampaignTemplateConnection>;
    campaignTemplatesAll(filter?: Scalars['FilterInput'], sort?: SortInput, fields?: Array<keyof CampaignTemplateFields | string>, headers?: Headers, token?: string): Promise<CampaignTemplate[]>;
    vendor(id: Scalars['ObjectId'], fields?: Array<keyof VendorFields | string>, headers?: Headers, token?: string): Promise<Vendor>;
    vendors(filter?: Scalars['FilterInput'], sort?: SortInput, after?: PageInfo['endCursor'], fields?: Array<keyof VendorFields | string>, headers?: Headers, token?: string): Promise<import("./generated/graphql").VendorConnection>;
    vendorsAll(filter?: Scalars['FilterInput'], sort?: SortInput, fields?: Array<keyof VendorFields | string>, headers?: Headers, token?: string): Promise<Vendor[]>;
    ...
    catalogs(filter?: Scalars['FilterInput'], sort?: SortInput, after?: PageInfo['endCursor'], fields?: Array<keyof CatalogFields | string>, headers?: Headers, token?: string): Promise<import("./generated/graphql").CatalogConnection>;
    catalogsAll(filter?: Scalars['FilterInput'], sort?: SortInput, fields?: Array<keyof CatalogFields | string>, headers?: Headers, token?: string): Promise<Catalog[]>;
    ...
    products(filter?: Scalars['FilterInput'], sort?: SortInput, after?: PageInfo['endCursor'], fields?: Array<keyof ProductFields | string>, headers?: Headers, token?: string): Promise<import("./generated/graphql").ProductConnection>;
    productsAll(filter?: Scalars['FilterInput'], sort?: SortInput, fields?: Array<keyof ProductFields | string>, headers?: Headers, token?: string): Promise<Product[]>;
    ...
    marketingCampaigns(filter?: Scalars['FilterInput'], sort?: SortInput, after?: PageInfo['endCursor'], fields?: Array<keyof MarketingCampaignFields | string>, headers?: Headers, token?: string): Promise<import("./generated/graphql").MarketingCampaignConnection>;
    marketingCampaignsAll(filter?: Scalars['FilterInput'], sort?: SortInput, fields?: Array<keyof MarketingCampaignFields | string>, headers?: Headers, token?: string): Promise<MarketingCampaign[]>;
    ...
    marketingAds(filter?: Scalars['FilterInput'], sort?: SortInput, after?: PageInfo['endCursor'], fields?: Array<keyof MarketingAdFields | string>, headers?: Headers, token?: string): Promise<import("./generated/graphql").MarketingAdConnection>;
    marketingAdsAll(filter?: Scalars['FilterInput'], sort?: SortInput, fields?: Array<keyof MarketingAdFields | string>, headers?: Headers, token?: string): Promise<MarketingAd[]>;
    result(id: Scalars['ObjectId'], fields?: Array<keyof ResultFields | string>, headers?: Headers, token?: string): Promise<Result>;
    results(filter?: Scalars['FilterInput'], sort?: SortInput, after?: PageInfo['endCursor'], fields?: Array<keyof ResultFields | string>, headers?: Headers, token?: string): Promise<import("./generated/graphql").ResultConnection>;
    resultsAll(filter?: Scalars['FilterInput'], sort?: SortInput, fields?: Array<keyof ResultFields | string>, headers?: Headers, token?: string): Promise<Result[]>;
    ...
    entitlements(filter?: Scalars['FilterInput'], sort?: SortInput, after?: PageInfo['endCursor'], fields?: Array<keyof EntitlementFields | string>, headers?: Headers, token?: string): Promise<import("./generated/graphql").EntitlementConnection>;
    entitlementsAll(filter?: Scalars['FilterInput'], sort?: SortInput, fields?: Array<keyof EntitlementFields | string>, headers?: Headers, token?: string): Promise<Entitlement[]>;
