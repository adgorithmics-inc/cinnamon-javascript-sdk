...
export declare class Cinnamon {
    ...
    organizations(filter?: OrganizationsFilterInput, after?: PageInfo['endCursor'], fields?: Array<keyof OrganizationFields | string>, headers?: Headers, token?: string): Promise<import("./generated/graphql").OrganizationConnection>;
    organizationsAll(filter?: OrganizationsFilterInput, fields?: Array<keyof OrganizationFields | string>, headers?: Headers, token?: string): Promise<Organization[]>;
    ...
    marketplaces(filter?: MarketplacesFilterInput, after?: PageInfo['endCursor'], fields?: Array<keyof MarketplaceFields | string>, headers?: Headers, token?: string): Promise<import("./generated/graphql").MarketplaceConnection>;
    marketplacesAll(filter?: MarketplacesFilterInput, fields?: Array<keyof MarketplaceFields | string>, headers?: Headers, token?: string): Promise<Marketplace[]>;
    ...
    mediaChannels(filter?: MediaChannelsFilterInput, after?: PageInfo['endCursor'], fields?: Array<keyof MediaChannelFields | string>, headers?: Headers, token?: string): Promise<import("./generated/graphql").MediaChannelConnection>;
    mediaChannelsAll(filter?: MediaChannelsFilterInput, fields?: Array<keyof MediaChannelFields | string>, headers?: Headers, token?: string): Promise<MediaChannel[]>;
    ...
    campaignTemplates(filter?: CampaignTemplatesFilterInput, after?: PageInfo['endCursor'], fields?: Array<keyof CampaignTemplateFields | string>, headers?: Headers, token?: string): Promise<import("./generated/graphql").CampaignTemplateConnection>;
    campaignTemplatesAll(filter?: CampaignTemplatesFilterInput, fields?: Array<keyof CampaignTemplateFields | string>, headers?: Headers, token?: string): Promise<CampaignTemplate[]>;
    vendor(id: Scalars['ObjectId'], fields?: Array<keyof VendorFields | string>, headers?: Headers, token?: string): Promise<Vendor>;
    vendors(filter?: VendorsFilterInput, after?: PageInfo['endCursor'], fields?: Array<keyof VendorFields | string>, headers?: Headers, token?: string): Promise<import("./generated/graphql").VendorConnection>;
    vendorsAll(filter?: VendorsFilterInput, fields?: Array<keyof VendorFields | string>, headers?: Headers, token?: string): Promise<Vendor[]>;
    ...
    catalogs(filter?: CatalogsFilterInput, after?: PageInfo['endCursor'], fields?: Array<keyof CatalogFields | string>, headers?: Headers, token?: string): Promise<import("./generated/graphql").CatalogConnection>;
    catalogsAll(filter?: CatalogsFilterInput, fields?: Array<keyof CatalogFields | string>, headers?: Headers, token?: string): Promise<Catalog[]>;
    ...
    products(filter?: ProductsFilterInput, after?: PageInfo['endCursor'], fields?: Array<keyof ProductFields | string>, headers?: Headers, token?: string): Promise<import("./generated/graphql").ProductConnection>;
    productsAll(filter?: ProductsFilterInput, fields?: Array<keyof ProductFields | string>, headers?: Headers, token?: string): Promise<Product[]>;
    ...
    marketingCampaigns(filter?: MarketingCampaignsFilterInput, after?: PageInfo['endCursor'], fields?: Array<keyof MarketingCampaignFields | string>, headers?: Headers, token?: string): Promise<import("./generated/graphql").MarketingCampaignConnection>;
    marketingCampaignsAll(filter?: MarketingCampaignsFilterInput, fields?: Array<keyof MarketingCampaignFields | string>, headers?: Headers, token?: string): Promise<MarketingCampaign[]>;
    ...
    marketingAds(filter?: MarketingAdsFilterInput, after?: PageInfo['endCursor'], fields?: Array<keyof MarketingAdFields | string>, headers?: Headers, token?: string): Promise<import("./generated/graphql").MarketingAdConnection>;
    marketingAdsAll(filter?: MarketingAdsFilterInput, fields?: Array<keyof MarketingAdFields | string>, headers?: Headers, token?: string): Promise<MarketingAd[]>;
    result(id: Scalars['ObjectId'], fields?: Array<keyof ResultFields | string>, headers?: Headers, token?: string): Promise<Result>;
    results(filter?: ResultsFilterInput, after?: PageInfo['endCursor'], fields?: Array<keyof ResultFields | string>, headers?: Headers, token?: string): Promise<import("./generated/graphql").ResultConnection>;
    resultsAll(filter?: ResultsFilterInput, fields?: Array<keyof ResultFields | string>, headers?: Headers, token?: string): Promise<Result[]>;
    ...
    entitlements(filter?: EntitlementsFilterInput, after?: PageInfo['endCursor'], fields?: Array<keyof EntitlementFields | string>, headers?: Headers, token?: string): Promise<import("./generated/graphql").EntitlementConnection>;
    entitlementsAll(filter?: EntitlementsFilterInput, fields?: Array<keyof EntitlementFields | string>, headers?: Headers, token?: string): Promise<Entitlement[]>;
